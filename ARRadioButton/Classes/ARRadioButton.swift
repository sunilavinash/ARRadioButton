...
@IBDesignable
class ARRadioButton: UIView, UITableViewDelegate, UITableViewDataSource {

  // MARK: - Properties
  /// The object that acts as the delegate of the ARRadio.
  /// The delegate must adopt the ARRadioDelegate protocol.
  var delegate: ARRadioDelegate? = nil
  //
...
/// The delegate of a ARRadio object must adopt the ARRadioDelegate protocol.
/// Method of the protocol allow the delegate to get notfiy when choice selected.
@objc protocol ARRadioDelegate: class {
